...
Course.getCeatedCourses = function (id, done) {
  ...
  Course.find(query, "price _creator thumb", function (err, course) {
    done(err, course);
  });
};
...
Course.creator = function (id, done) {
  ...
  Course.find(query, "_creator thumb", function (err, course) {
    done(err, course);
  });
};
...
Course.courseTitle = function (id, done) {
  ...
  Course.findOne(query, "title thumb", function (err, course) {
    done(err, course);
  });
};
...
Course.getPriceAndCreator = function (id, done) {
  ...
  this.findOne(query, "price _creator thumb", function (err, course) {
    done(err, course);
  });
};
...
Course.listCompanyCourses = function (id, callback) {
  ...
  }, "title subtitle price thumb", function (err, results) {
