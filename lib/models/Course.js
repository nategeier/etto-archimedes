...
Course.getCeatedCourses = function (id, done) {
  ...
  Course.find(query, "price _creator", function (err, course) {
    done(err, course);
  });
};
...
Course.creator = function (id, done) {
  ...
  Course.find(query, "_creator", function (err, course) {
    done(err, course);
  });
};
...
Course.courseTitle = function (id, done) {
  ...
  Course.findOne(query, "title", function (err, course) {
    done(err, course);
  });
};
...
Course.storeCourses = function (done) {
  ...
  Course.find(query, "price _creator title subtitle meta.keywords", function (err, course) {
    done(err, course);
  });
};
...
Course.listCompanyCourses = function (id, callback) {
  ...
  }, "title subtitle price", function (err, results) {
