...
app.get("/auth/logout", requiresLogin, controllers.Auth.logout);
app.get("/auth/getSession", requiresLogin, controllers.Auth.getSession);
app.post("/auth/updateSession", requiresLogin, controllers.Auth.updateSession);
...
//---- Asset
app.get("/asset/getS3Policy", requiresLogin, controllers.Asset.getS3Policy);
app.get("/asset/:id?", requiresLogin, controllers.Asset.find);
app.post("/asset", requiresLogin, controllers.Asset.create);
app.put("/asset/:id?", requiresLogin, controllers.Asset.update);
app.del("/asset/:id", requiresLogin, controllers.Asset.destroy);

//---- User
app.get("/user/listUsersInTier/:id", requiresLogin, controllers.User.listUsersInTier);
app.post("/user/inviteUser", requiresLogin, controllers.User.inviteUser);
app.post("/user/update_users_tier", requiresLogin, controllers.User.updateUsersTier);
app.post("/user/saveNewUser", controllers.User.saveNewUser);
app.get("/user/listUsersCourses/:id?", requiresLogin, requiresLogin, controllers.User.listUsersCourses);
