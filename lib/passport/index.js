...
var addPassport = function (app, controllers) {
  ...
  var linkedinConf = config.get("passport:linkedin");
  linkedinConf.callbackURL = protocol + [baseUrl, "auth/linkedin/callback"].join("/");
  passport.use(new LinkedInStrategy(linkedinConf, verifyHandler));
