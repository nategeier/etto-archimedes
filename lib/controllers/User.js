        ...
        newUser.save(function (err, addedUser) {
          ...
          if (String(code) === String(betaCode)) {
            ...
            userDetails(addedUser._id, function (err, results) {
              ...
              var htmlTxt = "<p>Hello " + user.name + ",</p>";
              htmlTxt += "<p>It's a pleasure to have " + user.tierTitle + " trying us out.</p>";
              htmlTxt += "<p>With our commitment to web integrations, beautiful design, mobile, and delegation, joining Coursetto is a step in the right direction to streamlining your company's learning process.</p>";
              htmlTxt += "<p>If you’d like to schedule a time for an introductory meeting we’d love to see how we could collaborate.</p>";
              ...
              Email.sendMail("Consider Coursetto for Pilot", htmlTxt, user.emails, "toPerson", function (err, results) {});
